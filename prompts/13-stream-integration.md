...
Use Expo API routes for Stream token generation and call creation. Do not expose Stream secrets in the Expo app. Use the selected lesson, selected track, and logged-in Clerk user when creating the call/session.
